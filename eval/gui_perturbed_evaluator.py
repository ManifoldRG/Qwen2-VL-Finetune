...
# Import shared vLLM client components
from vllm_client import ModelClient, ModelConfig, format_metadata_string

# Import constants that are still needed locally
...
class Evaluator:
    ...
    def _process_row(self, row: Dict, step_num: int, total_rows: int) -> Dict:
        ...
        raw_prediction = self.model_client.predict(instruction, image_path, metadata=metadata, use_pattern_matching=True)
